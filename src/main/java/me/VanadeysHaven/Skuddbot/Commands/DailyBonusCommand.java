...
public class DailyBonusCommand extends Command {
    ...
    private enum Bonus {
        ...
        HAPPY_NEW_YEAR(1, 1, 64000, 32000, Emoji.FIREWORKS, "Happy 2025!"),
        ...
        FIVE_DAYS(27, 12, 2000, 1000, Emoji.FIVE, "days until 2025!"),
        FOUR_DAYS(28, 12, 4000, 2000, Emoji.FOUR, "days until 2025!"),
        THREE_DAYS(29, 12, 8000, 4000, Emoji.THREE, "days until 2025!"),
        TWO_DAYS(30, 12, 16000, 8000, Emoji.TWO, "days until 2025!"),
        ONE_DAY(31, 12, 32000, 16000, Emoji.ONE, "days until 2025!");
