...
public enum Stat implements Data {
    ...
    FFA_BOUNTIES_SURVIVED       ("ffa_bounties_survived",   ValueType.INTEGER, "Bounties survived",          "bounties",     "0",  Category.FREE_FOR_ALL,      true,  true,  true ),
    FFA_BOUNTIES_LOST           ("ffa_bounties_lost",       ValueType.INTEGER, "Bounties lost",              "bounties",     "0",  Category.FREE_FOR_ALL,      true,  true,  true ),
    FFA_BETS_WON                ("ffa_bets_won",            ValueType.INTEGER, "Bets won (legacy)",          "bets",         "0",  Category.FREE_FOR_ALL,      true,  false, true ),
    FFA_BETS_LOST               ("ffa_bets_lost",           ValueType.INTEGER, "Bets lost (legacy)",         "bets",         "0",  Category.FREE_FOR_ALL,      true,  false, true ),
