...
public enum Stat implements Data {
    ...
    FFA_BETS_WON                ("ffa_bets_won",            ValueType.INTEGER, "Bets won (legacy)",          "bets",         "0",  Category.FREE_FOR_ALL,      true,  true,  true ),
    FFA_BETS_LOST               ("ffa_bets_lost",           ValueType.INTEGER, "Bets lost (legacy)",         "bets",         "0",  Category.FREE_FOR_ALL,      true,  true,  true ),
